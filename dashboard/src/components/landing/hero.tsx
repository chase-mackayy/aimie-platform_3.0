        ...
        <div>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
              ...
              <span style={{ fontSize: 11, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#22c55e', fontWeight: 600 }}>
                Live Demo
              </span>
            </div>
            <a href="tel:+18146322907" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
              <Phone size={16} color="#0ea5e9" />
              <span style={{ fontSize: 24, fontWeight: 700, color: 'white', fontFamily: `var(--font-geist-mono, monospace)` }}>
                +1 (814) 632-2907
              </span>
            </a>
            <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', margin: 0 }}>
              Call now and speak to AImie — our live AI receptionist
            </p>
          </div>
        </div>

        {/* RIGHT COLUMN — Orbital mascot */}
        <div style={{ position: 'relative', height: 520, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 60px rgba(14,165,233,0.25), 0 0 120px rgba(14,165,233,0.1)',
              top: '50%', left: '50%',
          ...
          <FloatingCard style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
              <Zap size={14} color="#0ea5e9" />
              <span style={{ fontFamily: `var(--font-geist-mono, monospace)`, fontWeight: 700, fontSize: 18, color: 'white' }}>
                &lt;480ms
              </span>
            </div>
